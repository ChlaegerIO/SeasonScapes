from dataVisu_engine.cam_lidar import CamLidarTool
...
TRANSFORM_MATRIX_FILEP = "data/transformation_matrices/Rshot/transformation_final_v4_flat.json"           # "data/2024-10-09/12-00-00/transformation.json"
POINT_MATCH_SAVE_PATH = "data/pointMatch/pointMatch.json"

DATA_ID = '85_20-WENGBELL_1'   # see list used for render_w2c_1Cam
...
pointMatch_savePath = Path(home_path, POINT_MATCH_SAVE_PATH)
...
######################## TASKS ########################
matchTool = CamLidarTool(lidar_path, lidar_fName, camera_path, DATA_ID, intrinsics_fileP, config, pointMatch_savePath)
matchTool.run()
